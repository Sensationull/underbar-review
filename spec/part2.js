  ...
  describe('Part II', function() {
    ...
    describe('every', function() {
      ...
      it('fails for a collection of all-falsy values', function() {
        ...
        expect(_.every(odd, isOdd)).to.be.false;
      });
    ...
    describe('some', function() {
      ...
      it('should fail for a set containing no matching values', function() {
        // Replace this line with an `expect` statement that tests
        // the behavior described by the `it` string
        expect(_.some([1, 3, 5], (x)=> { return x % 2 === 0 })).to.be.false;
      });
    ...
    describe('extend', function() {
      ...
      it('should override properties found on the destination', function() {
        ...
        var obj = {one: 1, two: 2};
        var source = {two: 3};
        expect(_.extend(obj, source)).to.eql({one: 1, two:3});
      });
    ...
    describe('defaults', function() {
      ...
      it('should copy any property whose key is not already set on the target', function() {
        // Replace this line with an `expect` statement that tests
        // the behavior described by the `it` string
        var destination = {flavor: "chocolate"};
        var source = {flavor: "vanilla", sprinkles: "lots"};
        console.log(_.defaults(destination, source))
        expect(_.defaults(destination, source)).to.eql({flavor: "chocolate", sprinkles:"lots"});
      });
